...
if not os.path.exists(registro_path):
    pd.DataFrame(columns=["fecha", "operario", "tijera", "hora_actual", "uso_dia"]).to_csv(registro_path, index=False)

# El resto de las funciones van aquí...
print("Código base listo. Rellenar funciones restantes según definición previa.")
